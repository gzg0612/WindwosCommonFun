...
#define HDD_SN      1//硬盘序列号
#define BOARD_SN    2        //2：主板序列号
#define CPU_ID      3        //3：CPU ID
#define BOIS_SN     4        //4：BIOS序列号
#define BOARD_MODEL 5        //5：主板型号
#define MAC_ADDR    6        //6：网卡当前MAC地址
#ifdef __cplusplus
extern "C"
{
#endif
